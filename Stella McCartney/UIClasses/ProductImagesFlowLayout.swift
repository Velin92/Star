...
class ProductImagesFlowLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        activeDistance = itemSize.width * ( 1 + zoomFactor) + minimumLineSpacing/2
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for attributes in rectAttributes {
            ...
            if distance.magnitude < activeDistance  {
                ...
                let alpha =  1 - transparencyFactor * normalizedDistance.magnitude
                attributes.alpha = alpha
            } else {
                attributes.alpha = 1 - transparencyFactor
            }
        }
